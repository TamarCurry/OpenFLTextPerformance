...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("TextPerformance", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("TextPerformance", null, 400, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "146";
		app.meta["company"] = "Tamar Curry";
		app.meta["file"] = "TextPerformance";
		app.meta["name"] = "TextPerformance";
		app.meta["packageName"] = "TextPerformance";
